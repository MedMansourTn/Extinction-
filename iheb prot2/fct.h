...
{
	SDL_Surface *screen;
	SDL_Surface *clav,*man, *image,*play1,*play2,*setting1,*setting2,*exit1,*exit2,*newg,*back1,*back2,*volume1,*sbg,*fullscreen1,*fullscreen2,*more1,*more2,*load1,*charact,*charbtn;
	SDL_Rect posnewgame;
	SDL_Rect possetting;
	SDL_Rect posquitter;
	SDL_Rect posback;
